...
setup(
  ...
  description = 'gRPC Client library to interact with Elastos Smartweb Service',   # Give a short description about your library
  ...
  download_url = 'https://github.com/cyber-republic/python-grpc-adenine/archive/v0.1.0.tar.gz',    # I explain this later on
