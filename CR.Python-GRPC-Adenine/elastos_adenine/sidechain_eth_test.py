...
def test_deploy_eth_contract():
	...
	response = sidechain_eth.deploy_eth_contract(test_input['api_key_to_use'], test_input['did_to_use'], test_input['network'],
...
def test_watch_eth_contract():
	sidechain_eth = SidechainEth(test_input['host'], test_input['port'], test_input['production'])
	response = sidechain_eth.watch_eth_contract(test_input['api_key_to_use'], test_input['did_to_use'], test_input['network'],
