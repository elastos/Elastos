...
//        return !TextUtils.isEmpty(goodsid) ? goodsid : "未知地区";
        ...
        List<Area> listArea = (List<Area>)  CacheDoubleUtils.getInstance().getSerializable("area");
                ...
                public void run() {
                    try {
                        ...
                        // Collections.sort(listArea);
                         CacheDoubleUtils.getInstance().put("area", (Serializable) listArea,  CacheDoubleUtils.DAY * 360);
