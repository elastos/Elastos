...
namespace Elastos {
	namespace ElaWallet {
		...
		public:
			 ...
			 * 						{"2102c632e27b19260d80d58a857d2acd9eb603f698445cc07ba94d52296468706331ac": "100000000",
			 * 						"2102775B47CCB0808BA70EA16800385DBA2737FDA090BB0EBAE948DD16FF658CA74Dac": "200000000"}
			 * @param memo         Remarks string. Can be empty string.
			 * @return             The transaction in JSON format to be signed and published.
			 */
			 ...
			 * @return Vote information in JSON format. The key is the public key, and the value is the stake. Such as:
			 * {
			 * 	 "2102848A8F1880408C4186ED31768331BC9296E1B0C3EC7AE6F11E9069B16013A9C5ac": "10000000",
			 * 	 "2102775B47CCB0808BA70EA16800385DBA2737FDA090BB0EBAE948DD16FF658CA74Dac": "200000000",
			 * 	 "2103E5B45B44BB1E2406C55B7DD84B727FAD608BA7B7C11A9C5FFBFEE60E427BD1DAac": "5000000000"
			 * }
			 */
