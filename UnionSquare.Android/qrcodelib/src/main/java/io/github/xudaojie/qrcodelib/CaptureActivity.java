    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK
            ...
            if (!TextUtils.isEmpty(path)) {
                ...
                Toast.makeText(mActivity, R.string.qr_imagepathnotfound, Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        if (grantResults.length > 0 && requestCode == REQUEST_PERMISSION_CAMERA) {
            if (grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ...
                new AlertDialog.Builder(mActivity)
                        ...
                        .setMessage(R.string.qr_requredpermission)
                        .setPositiveButton(R.string.qr_sure, new DialogInterface.OnClickListener() {
                            @Override
