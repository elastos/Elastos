...
/* Header */
MYC_Warning_1               : 'Chú Ý! kiễm tra cẩn thận URL trước khi bạn muốn đăng nhập vào ví hoặc tạo một ví mới. Cảnh giác cao đối với những trang web lừa đảo! ',
...
ADD_Ledger_0a               : 'Hảy mở lại trang MyCrypto trên một kết nối có tính bảo mật (SSL) ',
ADD_Ledger_0b               : 'Sử dụng [Chrome](https://www.google.com/chrome/browser/desktop/) hoặc [Opera](https://www.opera.com/) Để mở lại trang MyCrypto ',
ADD_Ledger_scan             : 'Kết nối với Ledger Wallet ',
ADD_MetaMask                : 'Connect to MetaMask ',
ADD_Ledger_scan             : 'Kết nối với Ledger Nano S ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Hảy mở lại trang MyCrypto trên một kết nối có tính bảo mật (SSL) ',
ADD_DigitalBitbox_0b        : 'Sử dụng [Chrome](https://www.google.com/chrome/browser/desktop/) hoặc [Opera](https://www.opera.com/) Để mở lại trang MyCrypto ',
...
MYWAL_Content_3             : 'Nếu bạn muốn sử dụng địa chỉ Ví này với MyCrypto CX trong tương lai, bạn sẽ cần phải tự thêm vào lại bằng cách sử dụng tập tin Private Key / JSON và mật khẩu. ',
...
ERROR_28                    : '**Bạn cần sử dụng tập tin chứa định dạng Keystore/JSON cùng với Mật khẩu hoặc Private Key của bạn** cho việc đăng nhập vào ví này trong tương lai. Hãy sao lưu và cất giữ nó cẩn thận tại kho lưu trữ của bạn! Không có cách nào đễ khôi phục Ví của bạn nếu bạn không sao lưu dữ liệu ví lại. Đọc Thêm [trang trợ giúp] (https://mycrypto.com/#help) đễ được hướng dẫn cụ thể. ',
...
HELP_Desc                   : 'Nếu bạn thấy có gì sai sót và có những câu hỏi nào khác cần được giải đáp. [Xin Liên Lạc Với Chúng Tôi](mailto:support@mycrypto.com), và chúng tôi sẽ giải đáp những thắc mắc từ bạn, ngoài ra chúng tôi sẽ cập nhật lại trang web nhằm đem lại nhiều tiện lợi nhất có thể cho người sử dụng trong tương lai! ',
HELP_Remind_Title           : 'Một số lưu ý! ',
HELP_Remind_Desc_1          : '**Ethereum, MyCrypto.com, và các nền tảng khác từ Javascript libraries mà chúng tôi sử dụng đang được phát triển một cách tích cực.** Mặc dù toàn bộ đã được chúng tôi kiễm tra rất kỹ lưỡng và hàng chục nghìn địa chỉ Ví đã được tạo thành công từ người sử dụng trên toàn cầu, nhưng vẫn có những vấn đề có thể xảy ra làm cho ETH của bạn bị mất đi. Xin vui lòng không nên đầu tư với số tiền nhiều hơn khả năng mà bạn đã cho rằng nó sẽ mất và hãy luôn cẩn thận. Trong trường hợp rủi ro xảy ra, chung tôi rất chân thành xin lỗi. Tuy nhiên **Chúng tôi sẽ không chịu bất cứ một trách nhiệm nào đối với số lượng Ether mà bạn đã bị mất!**. ',
HELP_Remind_Desc_2          : 'MyCrypto.com không phải "Ví Web". Vì vậy bạn không tạo tài khoản sau đó gửi số Ether của bạn cho chúng tôi dễ giữ hộ. Toàn bộ Dữ liệu sẽ không bao giờ bị rò rỉ ra khỏi máy tính/trình duyệt của bạn. Chúng tôi xây dựng nó nhằm giúp người sử dụng có thể đễ dàng tạo mới, lưu trữ và truy cập thông tin Ví của bạn và tương tác với Blockchain. ',
...
HELP_0_Desc_1               : 'MyCrypto giúp bạn có khả năng tạo Ví mới dùng dễ lưu trữ số lượng Ether của ban bởi chính mình, Ví được tạo ra không nằm trên bất cứ một sàn giao dịch nào. Quá trình tạo Ví điễn ra hoàn toàn trên máy tính cá nhân của bạn chứ không phải trên hệ thống máy chủ của chúng tôi. Do đó, khi bạn khởi tạo một Ví mới, **bạn chịu trách nhiệm hoàn toàn về vấn đề sao lưu dữ liệu đối với Ví được tạo**. ',
...
HELP_2b_Title               : '2b) Làm thế nào dễ bảo mật Ví / offline / lưu trữ lạnh cùng với MyCrypto? ',
HELP_2b_Desc_1              : 'Đến trang github của chúng tôi: [https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). ',
...
HELP_3_Desc_3               : 'Bạn hãy đi đến trang MyCrypto.com "Xem Thông Tin Ví". ',
...
HELP_4CX_Title              : '4) Làm thế nào dễ gửi đi Ether bằng cách sử dụng MyCrypto CX? ',
...
HELP_5_Title                : '5) Làm thế nào dễ kích hoạt MyCrypto.com với tính năng offline? ',
HELP_5_Desc_1               : 'Bạn hãy kích hoạt MyCrypto.com trên máy tính của bạn thay thế cho việc chạy trên máy chủ của Github. Bạn có thể khởi tạo Ví mới hoàn toàn trong tình trạng offline và gửi giao dịch đi từ trang "Giao dịch Offline". ',
HELP_5_Desc_7               : 'MyCrypto.com sẽ được chạy hoàn toàn trên máy tính của bạn. ',
...
HELP_5_Desc_9               : 'Cũng như việc chúng tôi liên tục cập nhật MyCrypto.com, vì vậy chúng tôi khuyên bạn nên cập nhận định kì cho các tập tin đã Lưu của định dạng repo. ',
...
HELP_8_Desc_1               : 'MyCrypto không phải là Ví online. Bạn không cần phải đăng nhập và không có bất cứ gì được lưu lại trên máy chủ của chúng tôi. Đây chỉ đơn giản là một giao diện cho phép bạn tương tác với blockchain. ',
HELP_8_Desc_2               : 'Nếu MyCrypto.com bị sập, bạn sẽ phải tìm một giải pháp khác (như là geth hoặc Ví Ethereum / Mist) dễ tiếp tục thực hiện giao dịch. Nhưng bạn không cần thiết phải "Mang" Ether của bạn ra khỏi MyCrypto bởi vì số Ether đó không nằm trong MyCrypto. Bởi vì số Ether đó đang nằm trong Ví Ethereum được khởi tạo thông qua trang của chúng tôi. ',
...
HELP_8_Desc_4               : 'Ngoài ra, Khả năng xảy ra vấn đề trang MyCrypto bị sập là rất khó. Cũng như việc chúng tôi không lưu trữ lại bất cứ dữ liệu gì vì vậy giá trị của nó sở hữu hoàn toàn bằng không. Nếu chúng tôi buộc phải  tháo tên miền này xuống, thì toàn bộ sẽ vẫn còn, tồn tại và công khai trên trang  [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). Bạn có thể tải tập tin nén của nó và chạy nó trực tiếp trên máy tính của bạn. ',

HELP_8CX_Title              : '8) Những gì sẽ xảy ra néu MyCrypto CX hoàn toàn biến mất? ',
...
HELP_8CX_Desc_2             : 'Điều đó cho thấy tầm **quan trọng** đối với việc sao lưu toàn bộ thông tin và dữ liệu Ví mới được khởi tạo từ bạn tại trang MyCrypto CX. Và việc sao lưu dữ liệu là cách dự phòng tốt khi những vấn đề xấu có thể xảy ra đối với MyCrypto CX hoặc máy tính của bạn, và nó giúp bạn có toàn bộ thông tin cần thiết dễ bạn có thể truy cập vào Ví và quản lý được số Ether của bạn. xem lại phần #2a dễ rõ hơn về cách sao lưu dữ liệu. ',
HELP_8CX_Desc_3             : 'Nếu vì một lý do bất kì buộc MyCrypto CX không tồn tại trên kho tiện ích của Chrome, bạn có thể tìm thấy mã nguồn trên Github và tải về máy của bạn. Xem phần #5 ở trên. ',
...
HELP_12_Title               : '12) Làm thế nào dễ tôi sử dụng Ví được khởi tạo từ MyCrypto trên geth / Ví Ethereum / Mist? ',
HELP_12_Desc_1              : 'Bạn phải sử dụng tập tin chứa định dạng JSON dành cho Geth/Mist từ MyCrypto v2+.... ',
...
HELP_14_Title               : '14) Một số trang khi khởi tạo Private key thông qua việc di chuyển con trỏ chuột máy tính trên màn hình. MyCrypto.com không làm theo cách này. Các ký tự Private key được tạo ra trên trang MyCrypto một cách an toàn nhất? ',
...
HELP_SecCX_Title            : 'Bảo mật - MyCrypto CX ',
...
HELP_SecCX_Desc_6           : 'Nếu chúng tôi mã hoá chúng, thì bạn phải điền mật khẩu khi bạn muốn xem số dư hiện tại của tài khoản bạn và xem tên gọi của tài khoản đó. Nếu như bạn cảm thấy đáp ứng nhu cầu bạn đã nêu, Chúng tôi cung cấp thêm lựa chọn khác dành cho bạn đó là MyCrypto.com thay vì phải sử dụng Chrome Extension. ',
...
HELP_Sec_Desc_2             : 'Chúng tôi đã bất đầu đưa trang của chúng tôi ra thị trường vào tháng 8 năm 2015. Nếu bạn tìm kiếm trên nguồn ["mycrypto" tại reddit](https://www.reddit.com/search?q=mycrypto), bạn sẽ thấy được lượng người hiện tại đang sử dụng và sự thành công của trang MyCrypto. ',
...
HELP_Sec_Desc_4             : 'Hãy kiễm tra URL -- Trang của chúng tôi được cung cấp thông qua Github và bạn có thể kiễm tra lại toàn bộ mã nguồn ở đây: [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages) đến các tên miền: [https://mycrypto.com](https://mycrypto.com). ',
HELP_Sec_Desc_5             : 'Đối với việc khởi tạo Ví, bạn có thể tải về [Mã nguồn](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). Xem phần #5 phía trên. ',
