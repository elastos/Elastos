...
ONBOARD_blockchain_content__5   :  '当你使用 MyCrypto.com 查看余额, 或者使用 [etherscan.io](https://etherscan.io)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自MyCrypto的独立系统.',
...
ONBOARD_secure_1_content__3     :  '记得每次都要检查 URL 地址: `https://mycrypto.com`.',
