...
tx_notFound_4               : 'Użyj menu w prawym górnym rogu aby wybrać inny węzeł ETH (np. `ETH (Etherscan.io)` lub `ETH (Infura.io)` lub `ETH (MyCrypto)`) i sprawdź ponownie.',
...
/* Header */
MYC_Warning_1               : 'Zawsze dokładnie sprawdzaj adres URL strony przed jej użyciem. Użycie fałszywej strony może pozbawić cię wszystkich środków! ',
...
MYC_Tagline                 : 'Portfel Ethereum - Open Source, JavaScript, Client-Side ',
...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim MyCrypto CX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',
...
ADD_Ledger_0a               : 'Otwórz MyCrypto ponownie na bezpiecznym połączeniu (SSL) ',
ADD_Ledger_0b               : 'Otwórz MyCrypto w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Otwórz MyCrypto ponownie na bezpiecznym połączeniu (SSL) ',
ADD_DigitalBitbox_0b        : 'Otwórz MyCrypto w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Twój węzeł musi obsługiwać HTTPS, aby można było się połączyć z nim przez MyCrypto.com. Możesz pobrać [repozytorium MyCrypto](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest) i uruchomić lokalnie aby połączyć się z dowolnym węzłem. Możesz też pobrać darmowy certyfikat SSL przez [LetsEncrypt](https://letsencrypt.org/)',
...
ERROR_28                    : '**Potrzebujesz plik Keystore i hasło, lub Klucz Prywatny** aby uzyskać dostęp do tego portfela w przyszłości. Wykonaj zewnętrzną kopię bezpieczeństwa! Nie ma możliwości odzyskania portfela jeżeli go nie zapiszesz. Wejdź na [stronę pomocy](https://mycrypto.com/#help) po instrukcje. ',
...
ERROR_35                    : 'Wprowadzony adres nie jest sprawdzony (checksummed). <a href="https://support.mycrypto.com/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> Więcej informacji</a>', // 35
...
HELP_0_Desc_1               : 'MyCrypto daje Ci możliwość generowania nowych portfeli abyś mógł przechowywać własne środki samodzielnie, nie na portalu wymiany walut. Ten proces odbywa się w całości na Twoim komputerze, nie na naszych serwerach. Z tego powodu, gdy generujesz nowy portfel, **to Ty jesteś odpowiedzialny za jego bezpieczne przechowywanie**. ',
...
HELP_2b_Title               : '2b) Jak mogę utworzyć portfel w 100% odizolowany od sieci globalnej (Cold Wallet) wykorzystując MyCrypto? ',
HELP_2b_Desc_1              : 'Wejdź na nasze konto github: [https://github.com/MyCryptoHQ/mycrypto.com/releases/latest](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). ',
...
HELP_3_Desc_3               : 'Przejdź na zakładkę "Wyświetl informacje o portfelu" na stronie MyCrypto.com. ',
...
HELP_4CX_Title              : '4)Jak wysłać Ether używając MyCrypto CX? ',
...
HELP_5_Title                : '5) Jak uruchomić MyCrypto offline/lokalnie? ',
HELP_5_Desc_1               : 'Możesz uruchomić MyCrypto lokalnie ze swojego komputera zamiast z serwerów GitHub\'a. Możesz wygenerować portfel całkowicie offline\'owo i wysyłać transakcje z zakładki "Wyślij offline". ',
HELP_5_Desc_7               : 'MyCrypto działa teraz w całości na Twoim komputerze. ',
...
HELP_5_Desc_9               : 'Ponieważ ciągle aktualizujemy MyCrypto, zalecamy co jakiś czas aktualizować  zapisaną wersję repozytorium. ',
...
HELP_8_Desc_1               : 'MyCrypto nie jest usługą portfela internetowego. Nie posiadasz loginu i nic nie jest zapisywane na naszych serwerach. To tylko interfejs, który pozwala korzystać z sieci Ethereum. ',
HELP_8_Desc_2               : 'Jeżeli MyCrypto.com zostanie wyłączona, musiałbyś znaleźć inny sposób (jak Ethereum Wallet / Mist) na korzystanie z sieci Ethereum. Nie musiałbyś jednak wypłacić swoich środków z MyCrypto, ponieważ one nie znajdują się na MyCrypto, a na portfelach, które zostały wygenerowane za pomocą naszej strony. ',
...
HELP_8_Desc_4               : 'W dodatku prawdopodobieństwo zamknięcia przez nas strony MyCrypto.com jest bliskie zeru. Koszty utrzymania strony są prawie żadne, ponieważ nie przechowujmy żadnych informacji. Jeśli nawet strona zostanie zamknięta, jest ona również i zawsze będzie publicznie dostępna na [https://github.com/MyCryptoHQ/mycrypto.com](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). Możesz ściągnąć paczkę ZIP i uruchomić MyCrypto lokalnie na własnym komputerze. ',

HELP_8CX_Title              : '8) Co się stanie jeżeli MyCrypto CX zniknie? ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą MyCrypto CX. W ten sposób, jeżeli cokolwiek stanie się MyCrypto CX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu MyCrypto CX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w MyCrypto do geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Używając pliku Keystore Geth/Mist z MyCrypto v2+.... ',
...
HELP_14_Title               : '14) Niektóre strony wykorzystują ruchy myszką przy generowaniu klucza prywatnego. MyCrypto tego nie robi. Czy generator liczb losowych w MyCrypto jest bezpieczny? ',
...
HELP_SecCX_Title            : 'Bezpieczeństwo - MyCrypto CX ',
...
HELP_Sec_Desc_2             : 'Działamy od sierpnia 2015. Jeśli wyszukasz ["mycrypto" na reddit](https://www.reddit.com/search?q=mycrypto), możesz znaleźć wielu ludzi, którzy używają naszego kodu bez najmniejszych problemów. ',
...
HELP_Sec_Desc_4             : 'Sprawdź adres URL -- Ta strona jest serwowana przez GitHub. Kod źródłowy jest dostępny pod: [https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages](https://github.com/MyCryptoHQ/mycrypto.com/tree/gh-pages). Strona jest dostępna pod domenami: [https://mycrypto.com](https://mycrypto.com). ',
HELP_Sec_Desc_5             : 'Do generowania portfeli możesz pobrać [kod źródłowy](https://github.com/MyCryptoHQ/mycrypto.com/releases/latest). Zobacz punkt 5 powyżej. ',
