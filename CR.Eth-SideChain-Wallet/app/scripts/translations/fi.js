...
ERROR_0                         :  '(error_00) Ole hyvä ja syötä kelpaava summa. Please enter a valid amount.', // 0
ERROR_1                         :  '(error_01) Salasanasi pitää olla vähintään 9 merkkiä pitkä. Ole hyvä ja varmista että käytät vahvaa salasanaa. Your password must be at least 9 characters. Please ensure it is a strong password.', // 1
ERROR_2                         :  '(error_02) Pahoittelut! Emme tunnista tämänlaista lompakko tiedostoa. Sorry! We don\'t recognize this type of wallet file.', // 2
ERROR_3                         :  '(error_03) Tämä ei ole validi lompakko tiedosto. This is not a valid wallet file.', // 3
ERROR_4                         :  '(error_04) Tätä yksikköä ei ole olemassa, ole hyvä ja käytä jotain seuraavista yksiköistä This unit doesn\'t exists, please use the one of the following units', // 4
ERROR_5                         :  '(error_05) Virheellinen osoite. Please enter a valid address.', // 5
ERROR_6                         :  '(error_06) Virheellinen salasana. Please enter a valid password.', // 6
ERROR_7                         :  '(error_07) Virheellinen summa. Please enter valid decimals (Must be an integer. Try 0-18.)', // 7
ERROR_8                         :  '(error_08) Virheellinen gas raja.Please enter a valid gas limit  (Must be an integer. Try 21000-4000000.)', // 8
ERROR_9                         :  '(error_09) Virheellinen tieto arvo.  Please enter a valid data value (Must be hex.)', // 9
ERROR_10                        :  '(error_10) Virheellinen gasin määrä. Try 20 GWEI / 20000000000 WEI.) Please enter a valid gas price. (Must be an integer. Try 20 GWEI / 20000000000 WEI.)',
ERROR_11                        :  '(error_11) Virheellinen nonce. (Must be integer.) ',
ERROR_12                        :  '(error_12) Virheellinen allekirjoitettu siirto. Invalid signed transaction.', // 12
ERROR_13                        :  '(error_13) Lompakko tällä kutsumanimellä on jo olemassa. A wallet with this nickname already exists.', // 13
ERROR_14                        :  '(error_14) Lompakkoa ei löytynyt. Wallet not found.', // 14
ERROR_15                        :  '(error_15) Ei näytä että ehdotusta tällä ID:llä olisi vielä olemassa tai tapahtui virhe ehdotusta luettaessa. Whoops. It doesn\'t look like a proposal with this ID exists yet or there is an error reading this proposal.', // 15 - NOT USED
ERROR_16                        :  '(error_16) Lompakko jolla on tämä osoite on jo muistissa. Ole hyvä ja tarkista oma lompakko sivusi. A wallet with this address already exists in storage. Please check your wallets page.', // 16
ERROR_17                        :  '(error_17) Riittämätön saldo gas * hinta + arvo. Sinulla täytyy olla vähintään 0.01 ETHiä tililläsi kattaaksesi gasin hinnan. Ole hyvä ja lisää hieman ETHiä ja kokeile uudelleen. Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more ETH to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://support.mycrypto.com/transactions/transactions-not-showing-or-pending.html)', // 17
ERROR_18                        :  '(error_18) Kaikki gas käytettäisiin tässä siirrossa. Tämä tarkoittaa että olet jo äänestänyt tässä ehdotuksessa tai debaatti aika on jo päättynyt. All gas would be used on this transaction. This means you have already voted on this proposal or the debate period has ended.', // 18
ERROR_19                        :  '(error_19) Virheellinen merkki Please enter a valid symbol', // 19
