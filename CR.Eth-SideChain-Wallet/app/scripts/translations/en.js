...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to Elastos Ethereum Sidechain Wallet MyCrypto',
...
ONBOARD_blockchain_content__5   :  'When you see your balance on MyCrypto or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
...
ONBOARD_whymyc_content__6       :  'If you are scared but want to use MyCrypto, [get a hardware wallet](https://support.wallet.elaeth.io/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__3     :  'Always check the URL: `https://wallet.elaeth.io`.',
...
ONBOARD_secure_3_content__6     :  '[Even more Security Tips!](https://support.wallet.elaeth.io/getting-started/protecting-yourself-and-your-funds.html)',
...
ERROR_35                        :  '(error_35) Input address is not checksummed. <a href="https://support.wallet.elaeth.io/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>',
...
GETH_GasLimit                   :  '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://support.wallet.elaeth.io/gas/what-is-gas-ethereum.html)',
...
GETH_Nonce                      :  "(geth-08) This TX's [nonce](https://support.wallet.elaeth.io/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://support.wallet.elaeth.io/transactions/check-status-of-ethereum-transaction.html).",
...
PARITY_GasLimitExceeded         :  "(parity-02) Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://support.wallet.elaeth.io/gas/what-is-gas-ethereum.html)",
...
PARITY_InsufficientGasPrice     :  "(parity-04) There is another transaction with same nonce in the queue, or the transaction fee is too low. Try incrementing the nonce by clicking the Generate button again. [Learn More.](https://support.wallet.elaeth.io/transactions/transactions-not-showing-or-pending.html)",
PARITY_InvalidGasLimit          :  "(parity-05) Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://support.wallet.elaeth.io/gas/what-is-gas-ethereum.html)",
PARITY_LimitReached             :  "(parity-06) There are too many transactions in the queue. Your transaction was dropped due to limit. Try increasing the gas price. [Learn More.](https://support.wallet.elaeth.io/transactions/transactions-not-showing-or-pending.html)",
...
PARITY_TooCheapToReplace        :  "(parity-08) TX Fee is too low. It does not satisfy your node's minimal fee (minimal: (d+), got: (d+)). Try increasing the gas price and/or gas limit. [Learn More.](https://support.wallet.elaeth.io/transactions/transactions-not-showing-or-pending.html)",


FOOTER_1                        :  'Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( wallet.elaeth.io ) before unlocking your wallet.',
