...
var sendTxCtrl = function($scope, $sce, walletService, $rootScope) {
    ...
    $scope.sendTx = function() {
        ...
        uiFuncs.sendTx($scope.signedTx, function(resp) {
            if (!resp.isError) {
                var checkTxLink = "https://wallet.elaeth.io?txHash=" + resp.data + "#check-tx-status";
                ...
                //var emailBtn = '<a class="btn btn-xs btn-info " href="mailto:support@wallet.elaeth.io?Subject=Issue%20regarding%20my%20TX%20&Body=' + emailBody + '" target="_blank" rel="noopener noreferrer">Confused? Email Us.</a>';
