...
<main class="tab-pane contracts active" ng-if="globalService.currentTab==globalService.tabs.mainnet.id" ng-controller='contractsCtrl' ng-cloak>
  ...
  <article class="row block" ng-show="visibility=='interactView'">
    ...
    @@if (site === 'web' ) { @@include( '../includes/contracts-interact-1.tpl', { "site": "web" } ) }
  ...
  <article class="row block" ng-show="visibility=='interactView' && showReadWrite">
    ...
    @@if (site === 'web' ) { @@include( '../includes/contracts-interact-2.tpl', { "site": "web" } ) }
  ...
  <article ng-show="visibility=='interactView'">
    ...
    @@if (site === 'web' ) { @@include( '../includes/contracts-interact-modal.tpl', { "site": "web" } ) }
  ...
  <article class="row block" ng-show="visibility=='deployView'">
    ...
    @@if (site === 'web' ) { @@include( '../includes/contracts-deploy-1.tpl', { "site": "web" } ) }
