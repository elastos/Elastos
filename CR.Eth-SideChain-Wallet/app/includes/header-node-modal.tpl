  ...
  <section class="modal-dialog">
    <section class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="small"><a href="https://support.wallet.elaeth.io/networks/run-your-own-node-with-mycrypto.html" target="_blank" rel="noopener noreferrer"> Instructions can be found here </a></p>

        <div ng-show="browserProtocol=='https:'" class="alert alert-danger small" translate="NODE_Warning">
          Your node must be HTTPS in order to connect to it via MyCrypto. You can [download MyCrypto &amp; run it locally](https://support.wallet.elaeth.io/offline/running-mycrypto-locally.html) to connect to your local node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)</a>.
        </div>
