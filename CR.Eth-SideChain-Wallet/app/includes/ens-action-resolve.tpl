<article class="col-xs-12 col-sm-10 col-sm-offset-1" ng-show="objENS.status==ensModes.owned && objENS.owner==objENS.deedOwner && wd">
  ...
  @@if (site === 'web' ) { @@include( './ens-resolve-information.tpl', { "site": "web" } ) }
  ...
  <section class="text-center"
    ...
    <div class="form-group" style="margin: 2em auto;">
      ...
      <input ng-model="newResolvedAddress" class="form-control" placeholder="0x4bbeEB066eD09B7AEd07bF39EEe0460DFa261520" ng-class="Validator.isValidAddress(tx.to) ? 'is-valid' : 'is-invalid'" />
...
@@if (site === 'web' ) { @@include( './ens-modal-resolve.tpl', { "site": "web" } ) }
