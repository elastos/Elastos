...
<section class="col-xs-12 clearfix">
  ...
  <span class="form-group" ng-show="contract.selectedFunc!=null">
    <p ng-show="contract.name == 'Exchange ETH to ELA'">
      <p translate="CONTRACT_Interact_Addr">_addr: ELA address</p>
      <p translate="CONTRACT_Interact_Amount">_amount: ETH value in wei, should be >= 200000000000000(0.0002 eth)</p>
      <p translate="CONTRACT_Interact_Fee">_fee: The fee that sends to operator, suggested value is 100000000000000(0.0001 eth)</p>
    </p>
