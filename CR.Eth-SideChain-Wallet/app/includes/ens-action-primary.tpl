    ...
    <section class="col-sm-8">
      ...
      <div class="form-group" ng-show="objENS.status==ensModes.reveal">
        ...
        <textarea class="form-control"
                  ...
                  placeholder='{"name":"exrnnrxe","nameSHA3":"0x0001640f2629bb323fca95bc13744478d5307ba0aca6e3a13f803691923ff00d","owner":"0x4bbeEB066eD09B7AEd07bF39EEe0460DFa261520","value":"100000000000000000","secret":"alley symptom elephant","secretSHA3":"0xc3a2ae4fd788a17a2e9e63868efa1d3589f1e97cf54662dbbfb12150cb5f9859"}'></textarea>
      </div>
      <!-- / Thing they copied -->
      ...
      <div class="form-group well" ng-show="objENS.txSent && (objENS.status==ensModes.auction || objENS.status==ensModes.open)">
        ...
        @@if (site === 'web' ) { @@include( './ens-confirm-table.tpl', { "site": "web" } ) }
