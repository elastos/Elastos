...
module.exports = (props) => {
  ...
  return (
        <footer>
          ...
          <a className="exit_link" target="_blank" href="https://twitter.com/ElastosInfo" onClick={(e) => onLinkClick(e)}><img src="artwork/tw.svg" height="22px" width="22px" /> </a>
          <a className="exit_link" target="_blank" href="https://www.facebook.com/elastosorg/" onClick={(e) => onLinkClick(e)}><img src="artwork/fb.svg" height="22px" width="22px" /></a>
