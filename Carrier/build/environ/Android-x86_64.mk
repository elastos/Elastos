...
CFLAGS   += -Wall -fPIC -D__x86_64__ -D__ANDROID__
CFLAGS   += -DPJ_AUTOCONF
...
CC        = $(TOOLCHAIN_DIR)/bin/x86_64-linux-android-gcc
CXX       = $(TOOLCHAIN_DIR)/bin/x86_64-linux-android-g++
AR        = $(TOOLCHAIN_DIR)/bin/x86_64-linux-android-ar
RANLIB    = $(TOOLCHAIN_DIR)/bin/x86_64-linux-android-ranlib
LDSHARED  = $(TOOLCHAIN_DIR)/bin/x86_64-linux-android-gcc
CPP       = $(TOOLCHAIN_DIR)/bin/x86_64-linux-android-cpp
