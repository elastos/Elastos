...
const t_1 = universal(import('../src/pages/team'), universalOptions)
const t_2 = universal(import('../src/pages/roadmap'), universalOptions)
const t_3 = universal(import('../src/pages/wallet'), universalOptions)
const t_4 = universal(import('../src/pages/developer'), universalOptions)
const t_5 = universal(import('../src/pages/404'), universalOptions)
