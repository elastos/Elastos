export default {
  ...
  crc: {
    ...
    desc: 'Elastos一直脚踏实地的前进，努力成为一个去中心化的自治组织。社区如果发现对Elastos生态系统有益的项目，社区有权力对其投票选择并提供资助。迄今为止我们已经为项目提供了超过10万美元的资金。新的理事会将于2019年8月前选举产生，CR将正式启动，社区的任何成员都可以成为理事会候选人。',
