...
const zh = {
  ...
  'home.explanation_3.box_2.text': '简明扼要地阐释了Cyber Republic的愿景并确定其未来运作和发展的价值观。',
  ...
  'suggestion.rules.1': 'There is no guarantee a suggestion will be selected by the council',
  'suggestion.rules.2': 'There is no guarantee a suggestion will be selected by the council',
  'suggestion.rules.3': 'There is no guarantee a suggestion will be selected by the council',
