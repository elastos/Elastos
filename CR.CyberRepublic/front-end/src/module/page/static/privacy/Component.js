      ...
      <div className="p_Privacy">
        ...
        <div className="ebp-page">
          <Row className="d_row">
            ...
            <ul>
              <li>
                <b>Affiliates and Acquisitions.</b>
                {' '}
We may share your personal information with our corporate affiliates (e.g., parent company, sister companies, subsidiaries, joint ventures, or other companies under common control).  If another company acquires our company, business, or our assets, we will also share your personal information with that company.
              ...
              <li>
                <b>Other Disclosures with Your Consent.</b>
                {' '}
We may ask if you would like us to share your information with other unaffiliated third parties who are not described elsewhere in this policy.
              ...
              <li>
                <b>Other Disclosures without Your Consent.</b>
                {' '}
We may disclose personal information in response to subpoenas, warrants, or court orders, in connection with any legal or regulatory process, or to comply with relevant laws.  We may also share your personal information in order to establish or exercise our rights, to defend against a legal claim, to investigate, prevent, or take action associated with possible illegal activities, suspected fraud, safety of person or property, for audit purposes, or a violation of our policies.
              </li>
              <li>
                <b>Service Providers.</b>
                {' '}
We may share your personal information with service providers.  Among other things service providers may help us to administer our website, conduct surveys, mail communications, and provide technical support. These service providers may collect, store, analyze, or otherwise process information on our behalf.
              </li>
              <li>
                <b>Advertising and Marketing.</b>
                {' '}
We may use any statements that you communicate to us through the website regarding Cyber Republic or Elastos or any of our products and services for advertising or marketing purposes.
              </li>
            </ul>
            ...
            <ul>
              <li>
                ...
                {' '}
We rely on you to update and correct your personal information. Our website allows you to modify or delete your account profile. If you cannot remove or need help deleting your personal information, please contact us using the instructions described in Section 10. Contact Information.
              </li>
              <li>
...
If you revoke your consent for the processing of personal information then we may no longer be able to provide you certain services. In some cases, we may limit or deny your request to revoke consent if the law permits or requires us to do so, if we are unable to adequately verify your identity, or if our processing is not based on your consent.
              ...
              <li>
                ...
                {' '}
If required by law, upon request, we will grant reasonable access to personal information that we hold about you. Please direct all requests using the instructions described in Section 10. Contact Information.
              </li>
              <li>
                <b>Online Tracking.</b>
                {' '}
We do not currently recognize automated browser signals regarding tracking mechanisms, which may include "Do Not Track" instructions.
              ...
              <li>
                ...
                {' '}
California residents under California Civil Code Section 1798.83 may be entitled to ask us for a notice describing what categories of personal information (if any) we share with third parties or affiliates for those parties to use for direct marketing. To submit your request, please email the address in the Contact Information section below with the subject line "California Privacy" and your request in the body of your email.
              </li>
              <li>
                <b>Decline to Provide.</b>
                {' '}
You may chose not to provide some types of personal information to us. This choice may result in our websites or their functionality not working.
              </li>
              <li>
                <b>Complaints.</b>
                {' '}
Complaints can be sent to us by way of email or letter using the instructions listed in Section 10. Contact Information. Some jurisdictions may also allow you to complain to a data protection authority as well.
              </li>
              <li>
                <b>Rights under GDPR.</b>
                {' '}
In addition to the above, you may also exercise your rights under GDPR as stated in Section 5. European & GDPR Privacy Rights.
              </li>
            </ul>
...
Consent
              <br/>
              <b>The reason we use this basis:</b>
              {' '}
With your consent, we process information to provide you with the best possible Cyber Republic experience. We may process information in accordance with Section 1. Purpose, Use and Processing of Your Personal Information. Types of Information we collect may vary as explained in Section 2. Types of Information We Collect. You can withdraw your consent at any time by contacting us in writing using the Contact Information below.
              <br/>
...
Legal obligation
              ...
              <b>The reason we use this basis:</b>
              {' '}
Cyber Republic may rely on this lawful basis if we need to process your personal data to comply with a common law or statutory obligation.
              <br/>
              <b>Data retention period:</b>
              {' '}
In accordance with local legislation and statutory obligation.
              <br/>
              <b>Sharing your information:</b>
              {' '}
We do not share your information with third parties.
...
We do not share your information with third parties.
            ...
            <ul>
              <li>
                <b>Minors.</b>
                {' '}
Our websites are not for individuals under age 13. Those individuals should not access a website or provide personal information to us.
              </li>
              <li>
                <b>Transmission of Data to Other Countries.</b>
                {' '}
Your personal information may be processed in other countries (such as the United States), where privacy laws may be less stringent than the laws in your country and where the government, courts, or law enforcement of that country may be able to access it.  By submitting your personal information to us you agree to the transfer, storage and processing of your information in those countries in accordance with applicable laws (ie. GDPR) and certain safeguards for such transfers shall be put in place.
                {' '}
              </li>
              <li>
                <b>Third Party Applications/Websites.</b>
                {' '}
