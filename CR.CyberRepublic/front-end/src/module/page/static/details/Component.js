...
export default class extends EmptyPage {
    ...
    renderEventDetails() {
      ...
      const hostedBy = this.props.task.createdBy ? `${this.props.task.createdBy.profile.firstName} ${
        this.props.task.createdBy.profile.lastName}` : 'unknown user'
      const hostedByID = this.props.task.createdBy ? this.props.task.createdBy._id : 'not-found'
      const hostedByAvatar = this.props.task.createdBy ? this.props.task.createdBy.profile.avatar : null
...
Hosted by
                <a onClick={() => this.navigateToUserProfile(hostedByID)}>{hostedBy}</a>
              </span>
    ...
    renderEventActions() {
      const attendance = _.find(this.props.task.candidates, (i) => i.user && i.user._id === this.props.currentUserId)
      const eventImage = this.props.task.thumbnail || '/assets/images/Elastos_Logo_Temp.png'
    ...
    ord_renderContent () {
      ...
      const communityName = (this.props.task.community && this.props.task.community.name) || 'Elastos Event'
