    ...
    render () {
        ...
        return (
            <div className="p_developerLearnDetail">
                <span dangerouslySetInnerHTML={{__html : part3}}></span>
                <img src={MergedMining} />
                <span dangerouslySetInnerHTML={{__html : part4}}></span>
                <img src={P2P} />
                <span dangerouslySetInnerHTML={{__html : part5}}></span>
                <img src={Chains} />
                <span dangerouslySetInnerHTML={{__html : part6}}></span>
                <img src={SideChains} />
                <span dangerouslySetInnerHTML={{__html : part7}}></span>
                <img src={SideChains2} />
                <span dangerouslySetInnerHTML={{__html : part8}}></span>
                <img src={SideChains3} />
                <span dangerouslySetInnerHTML={{__html : part9}}></span>
            </div>
        )
    }
}
