        ...
        <Row>
          <Col sm={24} md={24} lg={18} className="gridCol main-area">
            ...
            <Row>
                ...
                <Row>
                  ...
                  <Col span={20}>
                    {this.props.task && this.props.task.createdBy ? (
                      <p>
                        <a onClick={() => {
                          this.props.history.push(`/member/${this.props.task.createdBy._id}`)
                        }}>
                          {this.props.task.createdBy.username}
                        </a>
                      </p>
                    ) : <div className="center"><Spin size="small"/></div>}
                  </Col>
                </Row>
                <Row>
                  <Col span={4} className="label-col">
                  ...
                  <Col sm={24} md={20}>
                    <p>
                      ...
                      <span>
                        &nbsp; on
                        {' '}
                        {moment(this.props.task.approvedDate).format('MMM D, YYYY')}
                      </span>
                      )}
                    </p>
                  </Col>
              ...
              <Col span={6}>
                <img src={this.props.task.thumbnail} className="task-thumbnail"/>
              </Col>
              )}
            </Row>
...
&nbsp;
              ...
              <List
                ...
                renderItem={(candidate) => {
                  ...
                  if (candidateIsUserOrTeam) {
                    ...
                    listItemActions.unshift(
                      <Tooltip
                        title={isTaskOwner ? (candidateIsUserOrTeam ? 'You are automatically accepted' : 'Candidate already accepted') : 'Accepted candidate'}>
                  ...
                  if (isTaskOwner) {
                    ...
                    listItemActions.unshift(
                      <Tooltip title="View application">
                        <a onClick={() => {
                          this.props.history.push(`${prefix}/task-app/${this.props.task._id}/${candidate.user._id}`)
                        }}>
                  ...
                  return (
                    <List.Item actions={listItemActions}>
                      <Tooltip title="View profile">
                        <a onClick={() => {
                          this.props.history.push(`/member/${candidate.user._id}`)
                        }}>
                          {selfIcon}
                          {userOrTeamName}
                        </a>
  ...
  renderJoinButton() {
    ...
    if (this.state.isDeveloperEvent) {
      return (
        <Button disabled={true} className="join-btn" onClick={this.confirmDeveloperEventJoin}>
        Join Event
        </Button>
      )
      // shortcuts here
    ...
    if (!appliedAlready) {
      ...
      return (
        <Button disabled={true} className="join-btn" onClick={this.showModalApplyTask}>
          {buttonText}
        </Button>
      )
    ...
    return (
      <Button disabled={true} className="join-btn" onClick={() => {
