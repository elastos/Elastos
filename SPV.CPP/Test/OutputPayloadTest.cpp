...
TEST_CASE("OutputPayload Test", "[OutputPayload]") {
        ...
        SECTION("Serialize and deserialize") {
            ...
            for (size_t i = 0; i < vc1.size(); ++i) {
                ...
                for (size_t c = 0; c < vc1[i].GetCandidateVotes().size(); c++) {
                    REQUIRE((vc1[i].GetCandidateVotes()[c].GetCandidate() ==
                             vc2[i].GetCandidateVotes()[c].GetCandidate()));
    ...
    SECTION("PayloadStake") {
        PayloadStake p1(getRandUInt8(), getRandUInt168()), p2, p3;
