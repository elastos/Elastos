...
namespace Elastos {
	namespace SDK {
		...
		public:
			...
			SharedWrapperList<AddressPtr, BRAddress> getAllAddresses();
			...
			bool addressIsUsed(const AddressPtr &address);
			 ...
			 * @return
			 */
			const AddressPtr &getTransactionAddress(const TransactionPtr &transaction);
			 ...
			 */
			const AddressPtr &getTransactionAddressInputs(const TransactionPtr &transaction);
			 ...
			 */
			const AddressPtr &getTransactionAddressOutputs(const TransactionPtr &transaction);
