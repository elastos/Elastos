...
public:
    ...
    uint168(const uint168 &b);

    uint168(const std::string &str);

    explicit uint168(const bytes_t &vch);

    explicit uint168(uint8_t prefix, const bytes_t &vch);

    uint168 &operator=(const uint168 &b);

    bool operator<(const uint168 &b) const;
...
public:
    ...
    uint256 &operator=(const bytes_t &vch);
    ...
    explicit uint256(const bytes_t &vch);
};
