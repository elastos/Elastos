...
namespace Elastos {
	namespace ElaWallet {
		...
		public:
			...
			BigInt GetBalanceWithAddress(const uint256 &assetID, const Address &address, AssetTransactions::BalanceType type) const;
			...
			BigInt GetBalance(const uint256 &assetID, AssetTransactions::BalanceType type) const;
			...
			TransactionPtr
			CreateTransaction(const Address &fromAddress, const BigInt &amount,
			...
			BigInt GetTransactionAmountSent(const TransactionPtr &tx);
			...
			bool GetAsset(const uint256 &assetID, Asset &asset);
