...
var (
	...
	ethPortFlag = flag.Int("ethport", 20638, "Listener port for the devp2p connection")
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/elastos/Elastos.ELA.SideChain.ETH/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
