...
import (
	...
	"github.com/elastos/Elastos.ELA.SideChain.ETH/eth/tracers/internal/tracers"
)
...
// init retrieves the JavaScript transaction tracers included in Elastos.ELA.SideChain.ETH.
func init() {
