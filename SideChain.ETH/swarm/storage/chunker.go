...
import (
	...
	ch "github.com/elastos/Elastos.ELA.SideChain.ETH/swarm/chunk"
	"github.com/elastos/Elastos.ELA.SideChain.ETH/swarm/log"
	"github.com/elastos/Elastos.ELA.SideChain.ETH/swarm/spancontext"
...
type JoinerParams struct {
	...
	addr   Address
	getter Getter
	// TODO: there is a bug, so depth can only be 0 today, see: https://github.com/ethersphere/Elastos.ELA.SideChain.ETH/issues/344
	depth int
	ctx   context.Context
}
