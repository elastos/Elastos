...
[![Travis](https://travis-ci.org/ethereum/Elastos.ELA.SideChain.ETH.svg?branch=master)](https://travis-ci.org/ethereum/Elastos.ELA.SideChain.ETH)
...
Building Swarm requires Go (version 1.10 or later).
    ...
    go install github.com/elastos/Elastos.ELA.SideChain.ETH/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/elastos/Elastos.ELA.SideChain.ETH`.

Most likely you will be working from your fork of `Elastos.ELA.SideChain.ETH`, let's say from `github.com/nirname/Elastos.ELA.SideChain.ETH`. Clone or move your fork into the right place:

```
git clone git@github.com:nirname/Elastos.ELA.SideChain.ETH.git $GOPATH/src/github.com/elastos/Elastos.ELA.SideChain.ETH
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/elastos/Elastos.ELA.SideChain.ETH/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/elastos/Elastos.ELA.SideChain.ETH/wiki/Code-Review-Guidelines).
