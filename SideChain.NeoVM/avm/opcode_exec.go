...
var (
	OpExecList = [256]OpExec{
		...
		PUSH1:       {PUSH1, "1", opPushData, nil},
		PUSH2:       {PUSH2, "2", opPushData, nil},
		PUSH3:       {PUSH3, "3", opPushData, nil},
		PUSH4:       {PUSH4, "4", opPushData, nil},
		PUSH5:       {PUSH5, "5", opPushData, nil},
		PUSH6:       {PUSH6, "6", opPushData, nil},
		PUSH7:       {PUSH7, "7", opPushData, nil},
		PUSH8:       {PUSH8, "8", opPushData, nil},
		PUSH9:       {PUSH9, "9", opPushData, nil},
		PUSH10:      {PUSH10, "10", opPushData, nil},
		PUSH11:      {PUSH11, "11", opPushData, nil},
		PUSH12:      {PUSH12, "12", opPushData, nil},
		PUSH13:      {PUSH13, "13", opPushData, nil},
		PUSH14:      {PUSH14, "14", opPushData, nil},
		PUSH15:      {PUSH15, "15", opPushData, nil},
		PUSH16:      {PUSH16, "16", opPushData, nil},
