# Wallet Service for Token Sidechain Support - elastos.org
...
# copy folders
COPY service.wallet.tokensidechain /restful-services/wallet-service
...
RUN sed -i 's#XKUh4GLhFJiqAMTF6HyWQrV9pK9HcGUdfJ#XVfmhjxGxBKgzYxyXCJTb6YmaRfWPVunj4#g' /restful-services/wallet-service/base.api/src/main/resources/application.properties
